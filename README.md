...
** NOTE: The following materials and files imported to this Github page are only intended for educational purposes from the open data that can be queried for related data analytics career. These datas are subjected to change that are not reflected from the actual dataset. Use of any files or code for any other means or activities (such as solication) is strictly prohibited. **
...
As the need for services and resources become more common for the energy company itself, it is also important to keep in note of how the company is operating on both fiscal and monetary scale in order to get specific resources that are reflected both the company and consumers on a business and government scale. Since many are paid by both customers and city taxpayers, these funds are used to provide energy quality through its needs of maintenance as well as installing new tools/equipment and transporting them in various ways alongside with business and labor within the present technology.
...
[1]. City of Austin Operating Budget [OPEN DATA]
Data.gov: https://catalog.data.gov/dataset/program-budget-operating-budget-vs-expense-raw-data?from_hint=eyJxIjoiYnVkZ2V0Iiwic29ydCI6InJlbGV2YW5jZSJ9
Official Data Portal: https://data.austintexas.gov/Budget-and-Finance/Budget-Office-Program-Codes/du7k-5nxt/about_data

[2] Tong, C. (2026, June 18). Austin Energy Workers Cost the City $37K through vehicle misuse, audit finds. Austin American-Statesman. Retrieved June 19, 2026. 
https://www.statesman.com/news/article/austin-energy-city-vehicle-misuse-audit-22309660.php.

[3] City of Austin, Austin City Auditor’s Office. (2025, December). Austin Energy Fraud and Waste [Investigative Report]. pp. 1-17. https://austin.widen.net/view/pdf/xghlqntm1d/InvestigationReport_Austin_Energy_Fraud_Waste_December2025.pdf?t.download=true
